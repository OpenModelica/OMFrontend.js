...
export class ModelicaBrowserFileSystemLibrary extends ModelicaLibrary {
    ...
    override list(...path: string[]): AsyncIterableIterator<string> {
        throw new Error("Method not implemented.");
    }

    override read(...path: string[]): Promise<string | null> {
        throw new Error("Method not implemented.");
    }
